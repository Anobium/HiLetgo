# Product Review: 1602 Serial LCD Module Display With Blue Backlight HD44780 Controller

*What it is*

An LCD display that is 2-lines X 16-characters white with a blue dislay with a backlight.
